...
(function($) {
	...
	ScrollScene = function (options) {
		...
		this.remove = function () {
			console.debug("Scrollscene.remove");
			if (_parent) {
		...
		this.destroy = function (reset) {
			console.debug("Scrollscene.prototype.destroy");
			//console.debug(typeof this);
			if(this instanceof HorizontalScroll)
				{
				console.debug("HorizontalScroll here");
				//console.debug(Object.getPrototypeOf(this));
				//this.ainfo();
				}
			//console.debug("this.constructor"+this.constructor);
